  ...
  return (
    <>
      ...
      <div className="text-center p-4 mt-12 space-y-4">
        <h1 className="text-3xl font-bold text-purple-900">Welcome to 
         <span className=' text-purple-900'>&lt;</span>
          Loc
          <span className=' text-purple-900'>KAR/&gt;</span>
        </h1>
        <p className="text-purple-700 text-base">Manage your passwords safely and securely.</p>
        ...
        <section className="mt-6  text-purple-900 p-4 rounded-md shadow-sm text-sm">
          <h2 className="text-xl font-semibold">About Us</h2>
          <p className="mt-1 text-base">
            At LocKAR, we are committed to safeguarding your digital life with state-of-the-art security. 
            Our team of experts works tirelessly to create a password management system that is secure, 
            user-friendly, and designed to give you peace of mind.
          </p>
        </section>
